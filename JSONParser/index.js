...
let fs = require('fs');
let workbook = XLSX.readFile('../Params.csv');
...
sheet_name_list.forEach(function (y) {
    ...
    data.map(row => {
        ...
        if (row['Concurrence Users']) {
            ...
            data[2] ? rowParams.protocol = data[2].Protocol : '';
            data[2] ? rowParams.serverTest = data[2]['Server Test'] : '';
            data[2] ? rowParams.apiKey = data[2]['Api Key'] : '';
            data[2] ? rowParams.internalServer = data[2]['Internal Server'] : '';
